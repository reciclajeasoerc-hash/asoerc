        ...
        <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1a5c2a 0%, #2d7a3f 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ background: '#fff', borderRadius: 12, padding: 40, width: 360, boxShadow: '0 20px 60px rgba(0,0,0,.3)' }}>
                <div style={{ textAlign: 'center', marginBottom: 32 }}>
                    ...
                    <h1 style={{ fontSize: 22, fontWeight: 700, color: '#1a5c2a', marginTop: 8 }}>ASOERC</h1>
                ...
                <form onSubmit={submit}>
                    <label style={{ display: 'block', marginBottom: 16 }}>
                        ...
                        <input type="email" required value={form.email} onChange={e => setForm({ ...form, email: e.target.value })}
                            style={{ display: 'block', width: '100%', marginTop: 6, padding: '10px 12px', border: '1px solid #ddd', borderRadius: 6, fontSize: 14 }} />
                    </label>
                    ...
                    <button type="submit" disabled={loading} style={{ width: '100%', padding: '12px', background: '#1a5c2a', color: '#fff', border: 'none', borderRadius: 6, fontSize: 15, fontWeight: 600 }}>
